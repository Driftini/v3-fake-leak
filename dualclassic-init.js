...
dualstyle.innerHTML = "#s42_start {position: fixed;top: 4px;z-index: 1;};#s42_notif {position: fixed;top: 4px;right: 4px;height: 22px;z-index: 1;}#ui_menu_3 {transform: translate(0,220px)}"
